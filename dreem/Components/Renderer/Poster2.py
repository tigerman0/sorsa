# Embedded file name: /usr/lib/enigma2/python/Components/Renderer/Poster2.py
    ...
    def curPoster(self):
        ...
        if self.event is None:
            ...
            if self.event:
                ...
                pstrNm = path_folder + '{}_p.jpg'.format(evntNm).lower().replace(' ', '')
                if os.path.exists(pstrNm):
                    ...
                    try:
                        ...
                        if poster:
                            ...
                            dwn_poster = path_folder + '{}_p.jpg'.format(evntNm).lower().replace(' ', '')
                        ...
                        try:
                            ...
                            if series_id:
                                ...
                                if poster:
                                    ...
                                    dwn_poster3 = path_folder + '{}_p.jpg'.format(evntNm).lower().replace(' ', '')
                        ...
                        try:
                            ...
                            if series_id:
                                ...
                                if poster:
                                    ...
                                    dwn_poster2 = path_folder + '{}_p.jpg'.format(evntNm).lower().replace(' ', '')
                            ...
                            try:
                                ...
                                for i in range(redou):
                                    ...
                                    dwn_poster3 = path_folder + '{}_p.jpg'.format(evntNm, i + 1).lower().replace(' ', '')
